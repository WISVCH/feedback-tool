...
public class CHConnectConfiguration {
    ...
    public ClientConfigurationService clientConfigurationService() {
        RegisteredClientService registeredClientService = new JsonFileRegisteredClientService("src/main/java/ch/wisv/config/oidc-client-registration.json");
