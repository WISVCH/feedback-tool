...
//import com.ch.domain.feedback.FeedbackType;
...
//
//    @Autowired
//    public DataLoader(CourseService courseService, AssociationFeedbackService associationFeedbackService, EducationFeedbackService educationFeedbackService, InstructorService instructorService) {
...
//        Instructor instructor1 = new Instructor("Mr. Uil", "supermooi@uilen.nl");
//        Instructor instructor2 = new Instructor("C. Witteveen", "erelid@nieuw.nl");
...
//        instructors2.add(instructor1);
//        instructors2.add(instructor2);
//
//        Course course1 = new Course("TI3306", "Complexiteitstheorie", instructors2, ProgramEnum.BScTI);
//        Course course2 = new Course("TI1206", "OOP", instructors1, ProgramEnum.BScTI);
//        Course course3 = new Course("TI2206", "Software Engineering Methods", instructors1, ProgramEnum.BScTI);
